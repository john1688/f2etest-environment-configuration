...
rem 打开应用
taskkill /fi "username eq %username%" /s %computername% /u %username% /f -IM 2345Explorer.exe >nul
start /MAX "" "C:\Program Files (x86)\2345Soft\2345Explorer\2345Explorer.exe" --allow-no-sandbox-job %url%
