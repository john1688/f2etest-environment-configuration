...
rem 打开应用
taskkill /fi "username eq %username%" /s %computername% /u %username% /f -IM UCBrowser.exe >nul
start /MAX "" "C:\Program Files (x86)\UCBrowser\Application\UCBrowser.exe" --allow-no-sandbox-job %url%
