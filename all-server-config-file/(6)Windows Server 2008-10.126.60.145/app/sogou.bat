...
rem 打开应用
taskkill /fi "username eq %username%" /s %computername% /u %username% /f -IM SogouExplorer.exe >nul
start /MAX "" "C:\Program Files (x86)\SogouExplorer\SogouExplorer.exe" %url%
