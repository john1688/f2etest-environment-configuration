...
rem 打开应用
taskkill /fi "username eq %username%" /s %computername% /u %username% /f -IM QQBrowser.exe >nul
start /MAX "" "C:\Program Files (x86)\Tencent\QQBrowser\QQBrowser.exe" --allow-no-sandbox-job %url%
