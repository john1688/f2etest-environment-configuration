...
rem 打开应用
taskkill /fi "username eq %username%" /s %computername% /u %username% /f -IM launcher.exe >nul
start /MAX "" "C:\Program Files (x86)\Opera\launcher.exe" --allow-no-sandbox-job %url%
